...
MapWindow::MapWindow( MainWindow * parent )
...
bool MapWindow::maybeSave( void )
{
    if ( isModified ) {
        QMessageBox::StandardButton ret
            = QMessageBox::warning( this, tr( "Map Editor" ), tr( "'%1' has been modified.\nDo you want to save your changes?" ).arg( userFriendlyCurrentFile() ),
...
{
    if ( 0 <= pos.x() && 0 <= pos.y() && pos.x() < mapData.size().width() && pos.y() < mapData.size().height() ) {

...
if not exist "%tempPath%\asio"      mkdir "%tempPath%\asio"
...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://freefr.dl.sourceforge.net/project/asio/asio/1.20.0 (Stable)/asio-1.20.0.zip', '%tempPath%\asio\asio.zip')"
...
call :unpack_archive "asio\asio.zip" "asio"

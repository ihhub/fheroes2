...
xcopy /Y /s /Q "sdl_mixer\SDL_mixer-1.2.12\lib\x64\libogg-0.dll" "..\sdl\lib\x86"
xcopy /Y /s /Q "sdl_mixer\SDL_mixer-1.2.12\lib\x64\libvorbis-0.dll" "..\sdl\lib\x86"
xcopy /Y /s /Q "sdl_mixer\SDL_mixer-1.2.12\lib\x64\libvorbisfile-3.dll" "..\sdl\lib\x86"

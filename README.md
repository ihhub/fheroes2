...
See the [**fheroes2 installation guide**](/doc/INSTALL.md) for a detailed guide on the download and installation process for the different platforms and operating systems.
...
If you would like to build and run this project on PS Vita please follow the instructions on [**this page**](/doc/README_PSV.md).

### Compilation with CMake

If you would like to build the project using CMake please follow the instructions on [**this page**](/doc/README_cmake.md).

## Contribution

We welcome and appreciate any help, even if it is a tiny text or code change. Please read [**contribution**](/CONTRIBUTING.md) page before starting work on a pull request. 

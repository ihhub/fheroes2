...
public:
    ...
    void reEvaluateIfNeeded( const Heroes & hero );
    void reEvaluateIfNeeded( const int start, const Color::PlayerColor color, const double armyStrength, const uint8_t skill );
    ...
    uint32_t getDistance( const int start, const int targetIndex, const Color::PlayerColor color, const double armyStrength, const uint8_t skill = Skill::Level::EXPERT );

...
namespace Battle
{
    ...
    private:
        ...
        static void _redrawUnit( const fheroes2::Rect & pos, const Battle::Unit & unit, const bool revert, TypeUnitForDrawing typeUnitForDrawing, const uint8_t currentUnitColor,

...
namespace
{
    ...
    const std::array<SpellStats, Spell::SPELL_COUNT> spells = { {
        ...
        { gettext_noop( "Town Gate" ), 10, 225, 69, 48, 0, gettext_noop( "Returns the caster to the nearest town or castle currently owned. This spell cannot be cast if the hero is already in a town or a castle." ) },

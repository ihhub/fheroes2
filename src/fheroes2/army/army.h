...
public:
    ...
    void MoveTroops( const Troops & from, const size_t selectedTroopIndex = 4, const bool moveAll = false );
    ...
    static size_t getSelectedTroopIndex( const Troops & troopsArmy, const Troop * troopForIndex );
...
public:
    ...
    static void swapArmyTroops( Army & army1, Army & army2 );

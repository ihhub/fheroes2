...
namespace AI
{
    ...
    public:
        ...
        bool isValidHeroObject( const Heroes & hero, const double heroArmyStrength, const int32_t index, const double joiningArmyThreshold,
                                const bool underHero = false ) override;

...
namespace AI
{
    ...
    private:
        ...
        SpellcastOutcome spellSummonValue( const Spell & spell, const Battle::Arena & arena, const Color::PlayerColor heroColor ) const;
        ...
        Color::PlayerColor _myColor = Color::PlayerColor::NONE;

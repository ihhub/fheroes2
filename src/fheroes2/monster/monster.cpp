...
void LoadMonsterStatsFromCSVFile()
{
    ...
    std::vector<monstats_t> monsterVector;
    std::string stat;
    int statCounter = 0;
    ...
    if ( configFile ){
        ...
        for ( int i = 0; i < stats.size() / 17; i++ ){
            monstats_t monster{
                static_cast<u8>( atoi( stats[2 + statCounter].c_str() ) ), static_cast<u8>( atoi( stats[3 + statCounter].c_str() ) ),
                static_cast<u8>( atoi( stats[4 + statCounter].c_str() ) ), static_cast<u16>( atoi( stats[5 + statCounter].c_str() ) ),
                static_cast<u8>( atoi( stats[6 + statCounter].c_str() ) ), static_cast<u8>( atoi( stats[7 + statCounter].c_str() ) ),
                static_cast<u8>( atoi( stats[8 + statCounter].c_str() ) ), static_cast<u8>( atoi( stats[9 + statCounter].c_str() ) ),
                monsters[8 + statCounter].name, monsters[8 + statCounter].multiname,
                {static_cast<u16>( atoi( stats[10 + statCounter].c_str() ) ), static_cast<u8>( atoi( stats[11 + statCounter].c_str() ) ),
                static_cast<u8>( atoi( stats[12 + statCounter].c_str() ) ), static_cast<u8>( atoi( stats[13 + statCounter].c_str() ) ),
                static_cast<u8>( atoi( stats[14 + statCounter].c_str() ) ), static_cast<u8>( atoi( stats[15 + statCounter].c_str() ) ),
                static_cast<u8>( atoi( stats[16 + statCounter].c_str() ) )}};

...
namespace
{
    ...
    void populateMonsterData()
    {
        ...
        const fheroes2::MonsterGeneralStats monsterGeneralStats[Monster::MONSTER_COUNT] = {
            ...
            { "Rogue",            "Rogues",            4,  Race::NONE, 1, { 50,   0, 0, 0, 0, 0, 0 } },
            { "Nomad",            "Nomads",            4,  Race::NONE, 3, { 200,  0, 0, 0, 0, 0, 0 } },
            { "Ghost",            "Ghosts",            4,  Race::NONE, 4, { 1000, 0, 0, 0, 0, 0, 0 } },
            { "Genie",            "Genies",            4,  Race::NONE, 6, { 650,  0, 0, 0, 0, 0, 1 } },
            { "Medusa",           "Medusas",           4,  Race::NONE, 4, { 500,  0, 0, 0, 0, 0, 0 } },

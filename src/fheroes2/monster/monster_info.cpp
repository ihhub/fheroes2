    ...
    void populateMonsterData()
    {
        ...
        const fheroes2::MonsterGeneralStats monsterGeneralStats[Monster::MONSTER_COUNT]
            = { // name | plural name | growth | race | level | cost
                ...
                { gettext_noop( "Peasant" ), gettext_noop( "Peasants" ), 12, Race::KNGT, 1, { 0, 0, 0, 0, 0, 0, 20 } },
                { gettext_noop( "Archer" ), gettext_noop( "Archers" ), 8, Race::KNGT, 2, { 0, 0, 0, 0, 0, 0, 150 } },
                { gettext_noop( "Ranger" ), gettext_noop( "Rangers" ), 8, Race::KNGT, 2, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Pikeman" ), gettext_noop( "Pikemen" ), 5, Race::KNGT, 3, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Veteran Pikeman" ), gettext_noop( "Veteran Pikemen" ), 5, Race::KNGT, 3, { 0, 0, 0, 0, 0, 0, 250 } },
                { gettext_noop( "Swordsman" ), gettext_noop( "Swordsmen" ), 4, Race::KNGT, 4, { 0, 0, 0, 0, 0, 0, 250 } },
                { gettext_noop( "Master Swordsman" ), gettext_noop( "Master Swordsmen" ), 4, Race::KNGT, 4, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Cavalry" ), gettext_noop( "Cavalries" ), 3, Race::KNGT, 5, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Champion" ), gettext_noop( "Champions" ), 3, Race::KNGT, 5, { 0, 0, 0, 0, 0, 0, 375 } },
                { gettext_noop( "Paladin" ), gettext_noop( "Paladins" ), 2, Race::KNGT, 6, { 0, 0, 0, 0, 0, 0, 600 } },
                { gettext_noop( "Crusader" ), gettext_noop( "Crusaders" ), 2, Race::KNGT, 6, { 0, 0, 0, 0, 0, 0, 1000 } },
                { gettext_noop( "Goblin" ), gettext_noop( "Goblins" ), 10, Race::BARB, 1, { 0, 0, 0, 0, 0, 0, 40 } },
                { gettext_noop( "Orc" ), gettext_noop( "Orcs" ), 8, Race::BARB, 2, { 0, 0, 0, 0, 0, 0, 140 } },
                { gettext_noop( "Orc Chief" ), gettext_noop( "Orc Chiefs" ), 8, Race::BARB, 2, { 0, 0, 0, 0, 0, 0, 175 } },
                { gettext_noop( "Wolf" ), gettext_noop( "Wolves" ), 5, Race::BARB, 3, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Ogre" ), gettext_noop( "Ogres" ), 4, Race::BARB, 4, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Ogre Lord" ), gettext_noop( "Ogre Lords" ), 4, Race::BARB, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Troll" ), gettext_noop( "Trolls" ), 3, Race::BARB, 5, { 0, 0, 0, 0, 0, 0, 600 } },
                { gettext_noop( "War Troll" ), gettext_noop( "War Trolls" ), 3, Race::BARB, 5, { 0, 0, 0, 0, 0, 0, 700 } },
                { gettext_noop( "Cyclops" ), gettext_noop( "Cyclopes" ), 2, Race::BARB, 6, { 0, 0, 0, 0, 1, 0, 750 } },
                { gettext_noop( "Sprite" ), gettext_noop( "Sprites" ), 8, Race::SORC, 1, { 0, 0, 0, 0, 0, 0, 50 } },
                { gettext_noop( "Dwarf" ), gettext_noop( "Dwarves" ), 6, Race::SORC, 2, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Battle Dwarf" ), gettext_noop( "Battle Dwarves" ), 6, Race::SORC, 2, { 0, 0, 0, 0, 0, 0, 250 } },
                { gettext_noop( "Elf" ), gettext_noop( "Elves" ), 4, Race::SORC, 3, { 0, 0, 0, 0, 0, 0, 250 } },
                { gettext_noop( "Grand Elf" ), gettext_noop( "Grand Elves" ), 4, Race::SORC, 3, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Druid" ), gettext_noop( "Druids" ), 3, Race::SORC, 4, { 0, 0, 0, 0, 0, 0, 350 } },
                { gettext_noop( "Greater Druid" ), gettext_noop( "Greater Druids" ), 3, Race::SORC, 4, { 0, 0, 0, 0, 0, 0, 400 } },
                { gettext_noop( "Unicorn" ), gettext_noop( "Unicorns" ), 2, Race::SORC, 5, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Phoenix" ), gettext_noop( "Phoenixes" ), 1, Race::SORC, 6, { 0, 0, 1, 0, 0, 0, 1500 } },
                { gettext_noop( "Centaur" ), gettext_noop( "Centaurs" ), 8, Race::WRLK, 1, { 0, 0, 0, 0, 0, 0, 60 } },
                { gettext_noop( "Gargoyle" ), gettext_noop( "Gargoyles" ), 6, Race::WRLK, 2, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Griffin" ), gettext_noop( "Griffins" ), 4, Race::WRLK, 3, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Minotaur" ), gettext_noop( "Minotaurs" ), 3, Race::WRLK, 4, { 0, 0, 0, 0, 0, 0, 400 } },
                { gettext_noop( "Minotaur King" ), gettext_noop( "Minotaur Kings" ), 3, Race::WRLK, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Hydra" ), gettext_noop( "Hydras" ), 2, Race::WRLK, 5, { 0, 0, 0, 0, 0, 0, 800 } },
                { gettext_noop( "Green Dragon" ), gettext_noop( "Green Dragons" ), 1, Race::WRLK, 6, { 0, 0, 0, 1, 0, 0, 3000 } },
                { gettext_noop( "Red Dragon" ), gettext_noop( "Red Dragons" ), 1, Race::WRLK, 6, { 0, 0, 0, 1, 0, 0, 3500 } },
                { gettext_noop( "Black Dragon" ), gettext_noop( "Black Dragons" ), 1, Race::WRLK, 6, { 0, 0, 0, 2, 0, 0, 4000 } },
                { gettext_noop( "Halfling" ), gettext_noop( "Halflings" ), 8, Race::WZRD, 1, { 0, 0, 0, 0, 0, 0, 50 } },
                { gettext_noop( "Boar" ), gettext_noop( "Boars" ), 6, Race::WZRD, 2, { 0, 0, 0, 0, 0, 0, 150 } },
                { gettext_noop( "Iron Golem" ), gettext_noop( "Iron Golems" ), 4, Race::WZRD, 3, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Steel Golem" ), gettext_noop( "Steel Golems" ), 4, Race::WZRD, 3, { 0, 0, 0, 0, 0, 0, 350 } },
                { gettext_noop( "Roc" ), gettext_noop( "Rocs" ), 3, Race::WZRD, 4, { 0, 0, 0, 0, 0, 0, 400 } },
                { gettext_noop( "Mage" ), gettext_noop( "Magi" ), 2, Race::WZRD, 5, { 0, 0, 0, 0, 0, 0, 600 } },
                { gettext_noop( "Archmage" ), gettext_noop( "Archmagi" ), 2, Race::WZRD, 5, { 0, 0, 0, 0, 0, 0, 700 } },
                { gettext_noop( "Giant" ), gettext_noop( "Giants" ), 1, Race::WZRD, 6, { 0, 0, 0, 0, 0, 1, 2000 } },
                { gettext_noop( "Titan" ), gettext_noop( "Titans" ), 1, Race::WZRD, 6, { 0, 0, 0, 0, 0, 2, 5000 } },
                { gettext_noop( "Skeleton" ), gettext_noop( "Skeletons" ), 8, Race::NECR, 1, { 0, 0, 0, 0, 0, 0, 75 } },
                { gettext_noop( "Zombie" ), gettext_noop( "Zombies" ), 6, Race::NECR, 2, { 0, 0, 0, 0, 0, 0, 150 } },
                { gettext_noop( "Mutant Zombie" ), gettext_noop( "Mutant Zombies" ), 6, Race::NECR, 2, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Mummy" ), gettext_noop( "Mummies" ), 4, Race::NECR, 3, { 0, 0, 0, 0, 0, 0, 250 } },
                { gettext_noop( "Royal Mummy" ), gettext_noop( "Royal Mummies" ), 4, Race::NECR, 3, { 0, 0, 0, 0, 0, 0, 300 } },
                { gettext_noop( "Vampire" ), gettext_noop( "Vampires" ), 3, Race::NECR, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Vampire Lord" ), gettext_noop( "Vampire Lords" ), 3, Race::NECR, 4, { 0, 0, 0, 0, 0, 0, 650 } },
                { gettext_noop( "Lich" ), gettext_noop( "Liches" ), 2, Race::NECR, 5, { 0, 0, 0, 0, 0, 0, 750 } },
                { gettext_noop( "Power Lich" ), gettext_noop( "Power Liches" ), 2, Race::NECR, 5, { 0, 0, 0, 0, 0, 0, 900 } },
                { gettext_noop( "Bone Dragon" ), gettext_noop( "Bone Dragons" ), 1, Race::NECR, 6, { 0, 0, 0, 0, 0, 0, 1500 } },
                { gettext_noop( "Rogue" ), gettext_noop( "Rogues" ), 8, Race::NONE, 1, { 0, 0, 0, 0, 0, 0, 50 } },
                { gettext_noop( "Nomad" ), gettext_noop( "Nomads" ), 4, Race::NONE, 2, { 0, 0, 0, 0, 0, 0, 200 } },
                { gettext_noop( "Ghost" ), gettext_noop( "Ghosts" ), 3, Race::NONE, 3, { 0, 0, 0, 0, 0, 0, 1000 } },
                { gettext_noop( "Genie" ), gettext_noop( "Genies" ), 2, Race::NONE, 6, { 0, 0, 0, 0, 0, 1, 650 } },
                { gettext_noop( "Medusa" ), gettext_noop( "Medusas" ), 5, Race::NONE, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Earth Elemental" ), gettext_noop( "Earth Elementals" ), 4, Race::NONE, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Air Elemental" ), gettext_noop( "Air Elementals" ), 4, Race::NONE, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Fire Elemental" ), gettext_noop( "Fire Elementals" ), 4, Race::NONE, 4, { 0, 0, 0, 0, 0, 0, 500 } },
                { gettext_noop( "Water Elemental" ), gettext_noop( "Water Elementals" ), 4, Race::NONE, 4, { 0, 0, 0, 0, 0, 0, 500 } },

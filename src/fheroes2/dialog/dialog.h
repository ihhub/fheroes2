...
namespace Dialog
{
    ...
    bool InputString( std::string header, std::string & result, std::string title = {}, const size_t charLimit = 0 );
    bool inputMiltilineString( std::string header, std::string & result, std::string title, const int32_t inputAreaHeight, const size_t charLimit );

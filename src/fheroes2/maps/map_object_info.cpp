...
namespace
{
    ...
    void populateAdventureMiscellaneous( std::vector<Maps::ObjectInfo> & objects )
    {
        ...
        // New object.
        {
            ...
            object.topLevelParts.emplace_back( MP2::OBJ_ICN_TYPE_NEW_OBJECTS, 1U, fheroes2::Point{ 0, -1 }, MP2::OBJ_NON_ACTION_NEW_OBJECT );
            object.groundLevelParts.emplace_back( MP2::OBJ_ICN_TYPE_NEW_OBJECTS, 2U, fheroes2::Point{ -1, 0 }, MP2::OBJ_NONE, Maps::SHADOW_LAYER );

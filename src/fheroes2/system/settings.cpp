...
std::string Settings::String() const
{
    ...
    os << std::endl << "# !!! WARNING !!!" << std::endl << "# Modify this file manually only if you are absolutely sure what you are going!" << std::endl
       << "# !!! WARNING !!!" << std::endl;
    ...
    os << std::endl << "# Screen scaling type: nearest or linear (set by default)" << std::endl;

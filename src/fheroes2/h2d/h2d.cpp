...
namespace
{
    const std::set<std::string, std::less<>> resurrectionH2DFileListSample{ "adventure-map-grass-cave-diff-01.image",
                                                                            ...
                                                                            "black_cat.image",
                                                                            "black_cat_closed_eyes.image",
                                                                            "black_cat_tail_0.image",
                                                                            "black_cat_tail_1.image",
                                                                            "black_cat_tail_2.image",
                                                                            "black_cat_tail_3.image",
                                                                            "black_cat_tail_4.image",
                                                                            "black_cat_tail_5.image",

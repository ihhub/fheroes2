...
namespace
{
    ...
    void initializeHotKeyEvents()
    {
        ...
        hotKeyEventInfo[hotKeyEventToInt( Game::HotKeyEvent::WORLD_SELECT_HERO )]
            = { Game::HotKeyCategory::WORLD_MAP, gettext_noop( "hotkey|select hero" ), fheroes2::Key::KEY_LEFT_SHIFT };

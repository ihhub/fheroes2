...
namespace
{
    ...
    void initializeHotKeyEvents()
    {
        ...
        hotKeyEventInfo[hotKeyEventToInt( Game::HotKeyEvent::WORLD_MOVE_HERO_PORTRAIT_UP )]
            = { Game::HotKeyCategory::WORLD_MAP, gettext_noop( "hotkey|move hero portrait to top of list" ), fheroes2::Key::KEY_LEFT_SHIFT };

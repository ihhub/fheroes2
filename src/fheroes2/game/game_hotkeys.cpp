...
namespace Game
{
    ...
    const std::map<int, const char *> keyName
        = { { KEY_BACKSPACE, "Backspace" }, { KEY_RETURN, "Enter" }, { KEY_ESCAPE, "Escape" }, { KEY_SPACE, "Space" }, { KEY_EXCLAIM, "!" }, { KEY_QUOTEDBL, "\"" },
            { KEY_HASH, "#" }, { KEY_DOLLAR, "$" }, { KEY_AMPERSAND, "&" }, { KEY_QUOTE, "'" }, { KEY_LEFTPAREN, "(" }, { KEY_RIGHTPAREN, ")" }, { KEY_ASTERISK, "*" },
            ...
            { KEY_RIGHTBRACKET, "]" }, { KEY_CARET, "^" }, { KEY_UNDERSCORE, "_" }, { KEY_UNDERSCORE, "_" }, { KEY_ALT, "Alt" }, { KEY_CONTROL, "Ctrl" },
            { KEY_SHIFT, "Shift" }, { KEY_TAB, "Tab" }, { KEY_DELETE, "Del" }, { KEY_PAGEUP, "Page Up" }, { KEY_PAGEDOWN, "Page Down" }, { KEY_F1, "F1" },
            { KEY_F2, "F2" }, { KEY_F3, "F3" }, { KEY_F4, "F4" }, { KEY_F5, "F5" }, { KEY_F6, "F6" }, { KEY_F7, "F7" }, { KEY_F8, "F8" }, { KEY_F9, "F9" },
            { KEY_F10, "F10" }, { KEY_F11, "F11" }, { KEY_F12, "F12" }, { KEY_LEFT, "Left" }, { KEY_RIGHT, "Right" }, { KEY_UP, "Up" }, { KEY_DOWN, "Down" },
            { KEY_0, "0" }, { KEY_1, "1" }, { KEY_2, "2" }, { KEY_3, "3" }, { KEY_4, "4" }, { KEY_5, "5" }, { KEY_6, "6" }, { KEY_7, "7" }, { KEY_8, "8" },
            { KEY_8, "9" }, { KEY_a, "A" }, { KEY_b, "B" }, { KEY_c, "C" }, { KEY_d, "D" }, { KEY_e, "E" }, { KEY_f, "F" }, { KEY_g, "G" }, { KEY_h, "H" },
            { KEY_i, "I" }, { KEY_j, "J" }, { KEY_k, "K" }, { KEY_l, "L" }, { KEY_m, "M" }, { KEY_n, "N" }, { KEY_o, "O" }, { KEY_p, "P" }, { KEY_q, "Q" },
            { KEY_r, "R" }, { KEY_s, "S" }, { KEY_t, "T" }, { KEY_u, "U" }, { KEY_v, "V" }, { KEY_w, "W" }, { KEY_x, "X" }, { KEY_y, "Y" }, { KEY_z, "Z" } };
}

...
namespace
{
    ...
    void initializeHotKeyEvents()
    {
        ...
        hotKeyEventInfo[hotKeyEventToInt( Game::HotKeyEvent::BATTLE_SHOW_ENEMY_AREA_MODIFIER )]
            = { Game::HotKeyCategory::BATTLE, gettext_noop( "hotkey|hold to display enemy unit movement area" ), fheroes2::Key::KEY_LEFT_SHIFT };

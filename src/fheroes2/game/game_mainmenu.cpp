...
int Game::MainMenu( bool isFirstGameRun )
{
    ...
    if ( isFirstGameRun ) {
        ...
        Dialog::Message( "Please remember", "You can always change game resolution by clicking on the door on the left side of main menu. To switch between windowed "
                         "and full screen modes press 'F4' key on the keyboard. Enjoy the game!", Font::BIG,
                         Dialog::OK );
    }

...
public:
    ...
    void LoadFromMP2( const int32_t mapIndex, const Color::PlayerColor colorType, const int raceType, const bool isInJail, const std::vector<uint8_t> & data );
    ...
    bool Recruit( const Color::PlayerColor col, const fheroes2::Point & pt );

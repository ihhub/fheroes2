...
{
    const Castle * castle = Color::NONE != GetColor() ? world.GetCastle( GetCenter(), true ) : nullptr;
    return castle && castle->GetHeroes() == this ? castle : nullptr;
}

Castle * Heroes::inCastle( void )
{
    Castle * castle = Color::NONE != GetColor() ? world.GetCastle( GetCenter(), true ) : nullptr;
    return castle && castle->GetHeroes() == this ? castle : nullptr;
}

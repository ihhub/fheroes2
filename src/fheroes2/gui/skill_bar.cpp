...
bool PrimarySkillsBar::ActionBarLeftMouseSingleClick( const fheroes2::Point & /*unused*/, int & skill, const fheroes2::Rect &  /*unused*/)
{
    if ( Skill::Primary::UNKNOWN != skill ) {
...
bool PrimarySkillsBar::ActionBarCursor( const fheroes2::Point & /*unused*/, int & skill, const fheroes2::Rect &  /*unused*/)
{
    if ( Skill::Primary::UNKNOWN != skill ) {
...
bool SecondarySkillsBar::ActionBarLeftMouseSingleClick( const fheroes2::Point & /*unused*/, Skill::Secondary & skill, const fheroes2::Rect &  /*unused*/)
{
    if ( skill.isValid() ) {
...
bool SecondarySkillsBar::ActionBarCursor( const fheroes2::Point & /*unused*/, Skill::Secondary & skill, const fheroes2::Rect &  /*unused*/)
{
    if ( skill.isValid() ) {
        msg = _( "View %{skill} Info" );

    ...
    void populateArtifactData()
    {
        ...
        artifactData = {
            ...
            { gettext_noop( "Fizbin of Misfortune" ),
              gettext_noop( "The %{name} greatly decreases the hero's morale by %{count}." ),
              gettext_noop(
            ...
            { gettext_noop( "Lucky Rabbit's Foot" ),
              gettext_noop( "The %{name} increases the hero's luck in combat by %{count}." ),
              gettext_noop(
            ...
            { gettext_noop( "Wand of Negation" ),
              gettext_noop( "The %{name} makes all the hero's troops immune to dispel magic spells." ),
              gettext_noop(

...
namespace
{
    std::array<artifactstats_t, 104> artifacts = { {
        { 0, 12, TYPE3, "Ultimate Book of Knowledge", "The %{name} increases your knowledge by %{count}." },
        { 0, 12, TYPE3, "Ultimate Sword of Dominion", "The %{name} increases your attack skill by %{count}." },
        { 0, 12, TYPE3, "Ultimate Cloak of Protection", "The %{name} increases your defense skill by %{count}." },
        { 0, 12, TYPE3, "Ultimate Wand of Magic", "The %{name} increases your spell power by %{count}." },
        { 0, 6, TYPE3, "Ultimate Shield", "The %{name} increases your attack and defense skills by %{count} each." },
        { 0, 6, TYPE3, "Ultimate Staff", "The %{name} increases your spell power and knowledge by %{count} each." },
        { 0, 4, TYPE3, "Ultimate Crown", "The %{name} increases each of your basic skills by %{count} points." },
        { 0, 10, TYPE2, "Golden Goose", "The %{name} brings in an income of %{count} gold per turn." },
        { 0, 4, TYPE3, "Arcane Necklace of Magic", "The %{name} increases your spell power by %{count}." },
        { 0, 2, TYPE3, "Caster's Bracelet of Magic", "The %{name} increases your spell power by %{count}." },
        { 0, 2, TYPE3, "Mage's Ring of Power", "The %{name} increases your spell power by %{count}." },
        { 0, 3, TYPE3, "Witch's Broach of Magic", "The %{name} increases your spell power by %{count}." },
        { 0, 1, TYPE1, "Medal of Valor", "The %{name} increases your morale." },
        { 0, 1, TYPE1, "Medal of Courage", "The %{name} increases your morale." },
        { 0, 1, TYPE1, "Medal of Honor", "The %{name} increases your morale." },
        { 0, 1, TYPE1, "Medal of Distinction", "The %{name} increases your morale." },
        { 0, 2, TYPE1, "Fizbin of Misfortune", "The %{name} greatly decreases your morale by %{count}." },
        { 0, 1, TYPE3, "Thunder Mace of Dominion", "The %{name} increases your attack skill by %{count}." },
        { 0, 1, TYPE3, "Armored Gauntlets of Protection", "The %{name} increase your defense skill by %{count}." },
        { 0, 1, TYPE3, "Defender Helm of Protection", "The %{name} increases your defense skill by %{count}." },
        { 0, 1, TYPE3, "Giant Flail of Dominion", "The %{name} increases your attack skill by %{count}." },
        { 0, 1, TYPE0, "Ballista of Quickness", "The %{name} lets your catapult fire twice per combat round." },
        { 0, 2, TYPE3, "Stealth Shield of Protection", "The %{name} increases your defense skill by %{count}." },
        { 0, 3, TYPE3, "Dragon Sword of Dominion", "The %{name} increases your attack skill by %{count}." },
        { 0, 2, TYPE3, "Power Axe of Dominion", "The %{name} increases your attack skill by %{count}." },
        { 0, 3, TYPE3, "Divine Breastplate of Protection", "The %{name} increases your defense skill by %{count}." },
        { 0, 2, TYPE3, "Minor Scroll of Knowledge", "The %{name} increases your knowledge by %{count}." },
        { 0, 3, TYPE3, "Major Scroll of Knowledge", "The %{name} increases your knowledge by %{count}." },
        { 0, 4, TYPE3, "Superior Scroll of Knowledge", "The %{name} increases your knowledge by %{count}." },
        { 0, 5, TYPE3, "Foremost Scroll of Knowledge", "The %{name} increases your knowledge by %{count}." },
        { 0, 100, TYPE2, "Endless Sack of Gold", "The %{name} provides you with %{count} gold per day." },
        { 0, 75, TYPE2, "Endless Bag of Gold", "The %{name} provides you with %{count} gold per day." },
        { 0, 50, TYPE2, "Endless Purse of Gold", "The %{name} provides you with %{count} gold per day." },
        { 0, 0, TYPE3, "Nomad Boots of Mobility", "The %{name} increase your movement on land." },
        { 0, 0, TYPE3, "Traveler's Boots of Mobility", "The %{name} increase your movement on land." },
        { 0, 1, TYPE1, "Lucky Rabbit's Foot", "The %{name} increases your luck in combat." },
        { 0, 1, TYPE1, "Golden Horseshoe", "The %{name} increases your luck in combat." },
        { 0, 1, TYPE1, "Gambler's Lucky Coin", "The %{name} increases your luck in combat." },
        { 0, 1, TYPE1, "Four-Leaf Clover", "The %{name} increases your luck in combat." },
        { 0, 0, TYPE3, "True Compass of Mobility", "The %{name} increases your movement on land and sea." },
        { 0, 0, TYPE3, "Sailor's Astrolabe of Mobility", "The %{name} increases your movement on sea." },
        { 0, 0, TYPE0, "Evil Eye", "The %{name} reduces the casting cost of curse spells by half." },
        { 0, 2, TYPE0, "Enchanted Hourglass", "The %{name} extends the duration of all your spells by %{count} turns." },
        { 0, 0, TYPE0, "Gold Watch", "The %{name} doubles the effectiveness of your hypnotize spells." },
        { 0, 0, TYPE0, "Skullcap", "The %{name} halves the casting cost of all mind influencing spells." },
        { 0, 50, TYPE0, "Ice Cloak", "The %{name} halves all damage your troops take from cold spells." },
        { 0, 50, TYPE0, "Fire Cloak", "The %{name} halves all damage your troops take from fire spells." },
        { 0, 50, TYPE0, "Lightning Helm", "The %{name} halves all damage your troops take from lightning spells." },
        { 0, 50, TYPE0, "Evercold Icicle", "The %{name} causes your cold spells to do %{count} percent more damage to enemy troops." },
        { 0, 50, TYPE0, "Everhot Lava Rock", "The %{name} causes your fire spells to do %{count} percent more damage to enemy troops." },
        { 0, 50, TYPE0, "Lightning Rod", "The %{name} causes your lightning spells to do %{count} percent more damage to enemy troops." },
        { 0, 0, TYPE0, "Snake-Ring", "The %{name} halves the casting cost of all your bless spells." },
        { 0, 0, TYPE0, "Ankh", "The %{name} doubles the effectiveness of all your resurrect and animate spells." },
        { 0, 0, TYPE0, "Book of Elements", "The %{name} doubles the effectiveness of all your summoning spells." },
        { 0, 0, TYPE0, "Elemental Ring", "The %{name} halves the casting cost of all summoning spells." },
        { 0, 0, TYPE0, "Holy Pendant", "The %{name} makes all your troops immune to curse spells." },
        { 0, 0, TYPE0, "Pendant of Free Will", "The %{name} makes all your troops immune to hypnotize spells." },
        { 0, 0, TYPE0, "Pendant of Life", "The %{name} makes all your troops immune to death spells." },
        { 0, 0, TYPE0, "Serenity Pendant", "The %{name} makes all your troops immune to berserk spells." },
        { 0, 0, TYPE0, "Seeing-eye Pendant", "The %{name} makes all your troops immune to blindness spells." },
        { 0, 0, TYPE0, "Kinetic Pendant", "The %{name} makes all your troops immune to paralyze spells." },
        { 0, 0, TYPE0, "Pendant of Death", "The %{name} makes all your troops immune to holy spells." },
        { 0, 0, TYPE0, "Wand of Negation", "The %{name} protects your troops from the Dispel Magic spell." },
        { 0, 50, TYPE0, "Golden Bow", "The %{name} eliminates the %{count} percent penalty for your troops shooting past obstacles e.g. castle walls." },
        { 0, 1, TYPE4, "Telescope", "The %{name} increases the amount of terrain your hero reveals when adventuring by %{count} extra square." },
        { 0, 10, TYPE0, "Statesman's Quill", "The %{name} reduces the cost of surrender to %{count} percent of the total cost of troops you have in your army." },
        { 0, 10, TYPE0, "Wizard's Hat", "The %{name} increases the duration of your spells by %{count} turns." },
        { 0, 2, TYPE4, "Power Ring", "The %{name} returns %{count} extra power points/turn to your hero." },
        { 0, 0, TYPE0, "Ammo Cart", "The %{name} provides endless ammunition for all your troops that shoot." },
        { 0, 25, TYPE2, "Tax Lien", "The %{name} costs you %{count} gold pieces/turn." },
        { 0, 0, TYPE0, "Hideous Mask", "The %{name} prevents all 'wandering' armies from joining your hero." },
        { 0, 1, TYPE2, "Endless Pouch of Sulfur", "The %{name} provides %{count} unit of sulfur per day." },
        { 0, 1, TYPE2, "Endless Vial of Mercury", "The %{name} provides %{count} unit of mercury per day." },
        { 0, 1, TYPE2, "Endless Pouch of Gems", "The %{name} provides %{count} unit of gems per day." },
        { 0, 1, TYPE2, "Endless Cord of Wood", "The %{name} provides %{count} unit of wood per day." },
        { 0, 1, TYPE2, "Endless Cart of Ore", "The %{name} provides %{count} unit of ore per day." },
        { 0, 1, TYPE2, "Endless Pouch of Crystal", "The %{name} provides %{count} unit of crystal/day." },
        { 0, 1, TYPE3, "Spiked Helm", "The %{name} increases your attack and defense skills by %{count} each." },
        { 0, 2, TYPE3, "Spiked Shield", "The %{name} increases your attack and defense skills by %{count} each." },
        { 0, 1, TYPE3, "White Pearl", "The %{name} increases your spell power and knowledge by %{count} each." },
        { 0, 2, TYPE3, "Black Pearl", "The %{name} increases your spell power and knowledge by %{count} each." },

        { 0, 0, TYPE0, "Magic Book", "The %{name} enables you to cast spells." },
        ...
        { 0, 0, TYPE0, "Spell Scroll", "This %{name} gives your hero the ability to cast the %{spell} spell." },
        { 0, 3, TYPE3, "Arm of the Martyr", "The %{name} increases your spell power by %{count} but adds the undead morale penalty." },
        { 0, 5, TYPE3, "Breastplate of Anduran", "The %{name} increases your defense by %{count}." },
        { 0, 50, TYPE3, "Broach of Shielding", "The %{name} provides %{count} percent protection from Armageddon and Elemental Storm, but decreases spell power by 2." },
        { 0, 5, TYPE0, "Battle Garb of Anduran",
        ...
        { 0, 0, TYPE0, "Crystal Ball", "The %{name} lets you get more specific information about monsters, enemy heroes, and castles nearby the hero who holds it." },
        { 0, 50, TYPE0, "Heart of Fire", "The %{name} provides %{count} percent protection from fire, but doubles the damage taken from cold." },
        { 0, 50, TYPE0, "Heart of Ice", "The %{name} provides %{count} percent protection from cold, but doubles the damage taken from fire." },
        { 0, 5, TYPE3, "Helmet of Anduran", "The %{name} increases your spell power by %{count}." },
        { 0, 5, TYPE3, "Holy Hammer", "The %{name} increases your attack skill by %{count}." },
        { 0, 2, TYPE3, "Legendary Scepter", "The %{name} adds %{count} points to all attributes." },
        { 0, 1, TYPE1, "Masthead", "The %{name} boosts your luck and morale by %{count} each in sea combat." },
        { 0, 0, TYPE0, "Sphere of Negation", "The %{name} disables all spell casting, for both sides, in combat." },
        { 0, 5, TYPE3, "Staff of Wizardry", "The %{name} boosts your spell power by %{count}." },
        { 0, 4, TYPE3, "Sword Breaker", "The %{name} increases your defense by %{count} and attack by 1." },
        { 0, 5, TYPE3, "Sword of Anduran", "The %{name} increases your attack skill by %{count}." },
        { 0, 0, TYPE4, "Spade of Necromancy", "The %{name} gives you increased necromancy skill." },

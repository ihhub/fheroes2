...
void Castle::OpenWell( void )
{
    ...
    monsterAnimInfo.emplace_back( RandomMonsterAnimation( Monster( race, DWELLING_MONSTER1 ) ) );
    monsterAnimInfo.emplace_back( RandomMonsterAnimation( Monster( race, GetActualDwelling( DWELLING_MONSTER2 ) ) ) );
    monsterAnimInfo.emplace_back( RandomMonsterAnimation( Monster( race, GetActualDwelling( DWELLING_MONSTER3 ) ) ) );
    monsterAnimInfo.emplace_back( RandomMonsterAnimation( Monster( race, GetActualDwelling( DWELLING_MONSTER4 ) ) ) );
    monsterAnimInfo.emplace_back( RandomMonsterAnimation( Monster( race, GetActualDwelling( DWELLING_MONSTER5 ) ) ) );
    monsterAnimInfo.emplace_back( RandomMonsterAnimation( Monster( race, GetActualDwelling( DWELLING_MONSTER6 ) ) ) );

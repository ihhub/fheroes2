...
private:
    ...
    // Checks whether a building of exactly the given level has been built in the castle
    // (unlike the isBuild(), upgraded versions of the same building are not taken into account)

...
namespace ICN
{
    enum : int
    {
        ...
        // Real ICNs need a special reference to ICN files. Put generated by the engine ICNs at the end of this enumeration.
        LAST_VALID_FILE_ICN,
        ...
        BUTTON_EXIT_TOWN,
        BUTTON_TOWN_SETTINGS_OKAY_GOOD,
        BUTTON_TOWN_SETTINGS_OKAY_EVIL,
        BUTTON_TOWN_SETTINGS_CANCEL_GOOD,
        BUTTON_TOWN_SETTINGS_CANCEL_EVIL,

...
namespace fheroes2::AGG
{
    ...
    void generateDefaultImages( const int id )
    {
        ...
        case ICN::BUTTON_SMALL_TRADE_EVIL: {
            ...
            for ( int32_t i = 0; i < static_cast<int32_t>( _icnVsSprite[id].size() ); ++i ) {
                ...
                fheroes2::Copy( originalButton, originalButton.width() - startOffsetXMiddlePart, 0, out, widthFirstPart, 0, widthMiddlePart, originalButton.height() );
    ...
    bool LoadModifiedICN( int id )
    {
        ...
        case ICN::TOWNBKG5:
        case ICN::STONEBAK: {
            // These images are used in GUI and initially has no transparency or shadows to there is no need for the transform layer.
            LoadOriginalICN( id, true );

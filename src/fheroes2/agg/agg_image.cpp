...
namespace
{
    ...
    void generateGermanAlphabet()
    {
        ...
        // Normal font.
        {
            ...
            fheroes2::Copy( font[223 - 32], 0, 4 + 3, font[223 - 32], 0, 3 + 3, 3, 1 );
            fheroes2::Copy( font[223 - 32], 0, 4 + 3, font[223 - 32], 0, 4 + 3, 3, 1 );
            fheroes2::Copy( font[223 - 32], 0, 4 + 3, font[223 - 32], 0, 5 + 3, 3, 1 );

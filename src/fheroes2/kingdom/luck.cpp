...
{
    static std::string str_luck[] = { "Unknown", _("luck|Cursed"), _("luck|Awful"), _("luck|Bad"), _("luck|Normal"), _("luck|Good"), _("luck|Great"), _("luck|Irish") };
...
{
    static std::string str_desc_luck[] = { "Unknown",
